...
<body>
    <header>
        <div class="container header-inner" role="banner">
            <div style="display:flex;align-items:center;gap:18px;">
                ...
                <a class="brand" href="#">
                    <span>Wakanda<span class="accent">Shop</span></span>
                </a>
            </div>
    ...
    <main>
        ...
        <section class="hero" role="img" aria-label="Hero banner">
            <div class="container">
                <h1>Old Wedding Site — Premium Picks</h1>
    ...
    <footer>
        <div class="container" style="display:flex;flex-wrap:wrap;gap:28px;align-items:flex-start;justify-content:space-between">
            <div style="max-width:360px">
                <div style="font-weight:700;font-size:18px">WakandaShop</div>
        ...
        <div style="text-align:center;margin-top:22px;color:var(--muted);font-size:13px">© <span id="year"></span> WakandaShop. All rights reserved.</div>
    </footer>
